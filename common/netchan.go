 ...
 */
func (T *qCommon) Netchan_OutOfBand(net_socket shared.Netsrc_t, adr shared.Netadr_t, data []byte) error {
	...
	/* send the datagram */
	return T.NET_SendPacket(net_socket, send.Data(), adr)
}

/*
 * Sends a text message in an out-of-band datagram
 */
func (T *qCommon) Netchan_OutOfBandPrint(net_socket shared.Netsrc_t, adr shared.Netadr_t, format string, a ...interface{}) error {
	str := fmt.Sprintf(format, a...)
	return T.Netchan_OutOfBand(net_socket, adr, []byte(str))
}
