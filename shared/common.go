...
const (
	...
	NA_IPX           Netadrtype_t = 3
	NA_BROADCAST_IPX Netadrtype_t = 4
	NA_IP6           Netadrtype_t = 5
	NA_MULTICAST6    Netadrtype_t = 6

	NS_CLIENT Netsrc_t = 0
	NS_SERVER Netsrc_t = 1
